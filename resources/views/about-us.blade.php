    ...
    <div class="row">
      <div class="col-12 col-md-8 col-lg-7 mx-auto">
        <div class="about-content text-center">
          <h1>Welcome to SABE Ltd</h1>
          <p>At SABE Ltd, we're a cross-functional team based in Kigali, Rwanda, with a strong presence in the Muhima Sector.  We believe in building not just structures, but strong and lasting relationships.  This commitment is reflected in everything we do from prioritizing safety standards to fostering a collaborative environment that emphasizes client needs.</p>
        </div>
      </div>
    </div>
    <div class="row">
      ...
      <div class="col-md-6 order-2 order-md-1">
        <div class="company-history" data-aos="fade-up" data-aos-once="true" data-aos-duration="1000" data-aos-delay="50">
          <div class="company-history--header">
            <h3>Our Focus – Your Success</h3>
          </div>
          <ol class="company-history--list">
            <li>
              <div class="company-history--details">
                <h6>Strong Client Relationships:</h6>
                <p>Communication and collaboration are at the heart of our approach. We listen closely to understand your vision and work together to bring it to life.</p>
              </div>
            </li>
            <li>
              <div class="company-history--details">
                <h6>Unwavering Safety Standards:</h6>
                <p>We prioritize the safety of our team, our clients, and the communities we serve.</p>
              </div>
            </li>
            <li>
              <div class="company-history--details">
                <h6>Innovative Solutions:</h6>
                <p> We embrace the latest technologies and methodologies to deliver creative and sustainable construction projects.</p>
              </div>
            </li>
          </ol>
        </div>
    ...
    <div class="row align-items-center" >
      ...
      <div class="col-md-6 col-lg-5 ms-lg-auto  order-lg-2 order-md-1" data-aos="fade-up" data-aos-once="true" data-aos-duration="1500" data-aos-delay="200">
        <div class="company-vision--content">
          ...
          <p>
          SABE Ltd's operations span across all districts of Rwanda. This extensive reach allows us to leverage our expertise and experience to serve a wide range of clients throughout the country.  Our reputation for quality, creativity, and meticulous attention to detail precedes us.
          </p>
          <p>Whether you're located in Kigali or another district, SABE Ltd. is ready to be your trusted partner.  Contact us today and discover how our commitment to excellence can transform your project vision into a reality.</p>
        </div>
      </div>
    </div>
  </div>
