...
<head>
    ...
    <title>Adobe Photoshop - Our Softwares Courses | SABE Ltd</title>
      ...
      <div class="col-lg-8">
        <div class="property-details-content">
          ...
          <div class="property-details-content-details">
            <p>Adobe Photoshop is a powerful image editing software used for photo retouching, graphic design, and digital art. It is a staple for creative professionals.</p>
            <p class="bold">
              Course Content
            </p>
            <p>
            1. Introduction to Photoshop interface <br>
            2. Basic image editing and retouching <br>
            3. Working with layers and masks<br>
            4. Color correction and adjustments<br>
            5. Selection tools and techniques<br>
            6. Typography and text effects <br>
            7. Using filters and effects <br>
            8. Advanced compositing techniques <br>
            9. Exporting and optimizing images<br>
            10. Creative project work
            </p>
          </div>
