...
<head>
    ...
    <title>Archicad - Our Softwares Courses | SABE Ltd</title>
      ...
      <div class="col-lg-8">
        <div class="property-details-content">
          ...
          <div class="property-details-content-details">
            <p>Archicad is a BIM software solution developed by Graphisoft for architects working in the architecture-engineering-construction (AEC) industry.</p>
            <p class="bold">
              Course Content
            </p>
            <p>
            1. Introduction to BIM and Archicad <br>
            2. User interface and navigation <br>
            3. Basic drawing and modeling techniques<br>
            4. Detailed design of building elements<br>
            5. MEP modeling and analysis<br>
            6. Collaboration and teamwork <br>
            7. Visualization and rendering <br>
            8. Documentation and layouting <br>
