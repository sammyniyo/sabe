...
<head>
    ...
    <title>Autocad - Our Softwares Courses | SABE Ltd</title>
      ...
      <div class="col-lg-8">
        <div class="property-details-content">
          ...
          <div class="property-details-content-details">
            <p>AutoCAD is a versatile CAD software used for creating precise 2D and 3D drawings. It is widely used in architecture, engineering, and construction.</p>
            <p class="bold">
              Course Content
            </p>
            <p>
            1. Introduction to AutoCAD and its interface <br>
            2. Basic drawing commands and tools <br>
            3. Creating and editing 2D geometry<br>
            4. Layer management and properties<br>
            5. Dimensioning and annotations<br>
            6. Introduction to 3D modeling <br>
            7. Plotting and printing techniques <br>
            8. Advanced drawing techniques and customization<br>
            9. Project-based exercises
            </p>
          </div>
        </div>
