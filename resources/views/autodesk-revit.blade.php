...
<head>
    ...
    <title>Autodesk Revit - Our Softwares Courses | SABE Ltd</title>
      ...
      <div class="col-lg-8">
        <div class="property-details-content">
          <div class="property-details-content-title">
            <h4>Autodesk Revit</h4>
          </div>
          <div class="property-details-content-details">
            <p>Autodesk Revit is a BIM (Building Information Modeling) software that allows architects, engineers, and construction professionals to create and manage building designs and data.</p>
            <p class="bold">
              Course Content
            </p>
            <p>
            1. Introduction to Revit <br>
            2. Interface and basic tools <br>
            3. Creating and modifying building elements (walls, floors, roofs)<br>
            4. Family creation and management<br>
            5. Structural modeling and analysis<br>
            6. MEP (Mechanical, Electrical, Plumbing) design <br>
            7. Rendering and visualization <br>
            8. Collaboration and worksharing<br>
            9. Documentation and detailing
            </p>
          </div>
        </div>
