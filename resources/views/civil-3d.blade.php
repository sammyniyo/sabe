...
<head>
    ...
    <title>Civil 3d - Our Softwares Courses | SABE Ltd</title>
  ...
  <div class="container">
    <div class="row">
      ...
      <div class="blog-single-featured-thumb">
          <img src="images/courses/civil3d.jpg" alt="Civil 3d" >
        </div>
      </div>
      <div class="col-lg-4">
        ...
        <div class="property-details-content">
         <div class="property-details-content-title">
          ...
          <div class="property-details-content-details">
            <p>Civil 3D is a design and documentation software for civil engineering. It supports BIM with integrated features to improve drafting, design, and construction documentation.</p>
            <p class="bold">
              Course Content
            </p>
            <p>
            1. Introduction to Civil 3D and its interface <br>
            2. Survey data import and management <br>
            3. Surface creation and analysis<br>
            4. Alignment and profile design<br>
            5. Corridor modeling<br>
            6. Pipe network design <br>
            7. Grading and earthwork calculation <br>
            8. Quantity takeoff and documentation<br>
            9. Project collaboration and management
            </p>
          </div>
        </div>
