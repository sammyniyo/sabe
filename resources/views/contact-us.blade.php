...
<head>
    ...
    <title>Contact Us | SABE Ltd</title>
      ...
      <div class="col-12">
        ...
        <form action="{{ route('contact.store') }}" method="POST" class="contact-form-items">
          ...
          <div class="contact-form-address">
            ...
            <a href="tel:+250794423156" class="phone d-flex align-items-center">
              <i class="ph-phone"></i>
              <span>+250 794 423 156</span>
            </a>
            <a href="mailto:sabeltdrw@gmail.com" class="mail d-flex align-items-center">
              <i class="ph-envelope-simple-open"></i>
