...
<head>
    ...
    <title>Etabs - Our Softwares Courses | SABE Ltd</title>
      ...
      <div class="col-lg-8">
        <div class="property-details-content">
          ...
          <div class="property-details-content-details">
            <p>Learn powerful tools for building analysis and design. Master ETABS to analyze and model complex structures, ensuring their stability and safety. (Course content may include: load application, material properties, member definition, analysis procedures, result interpretation)</p>
            <p class="bold">
              Course Content
            </p>
            <p>
            1. Introduction to ETABS and its interface <br>
            2. Modelling structural elements (beams, columns, slabs)<br>
            3. Load applications and combinations<br>
            4. Analysis of structures (linear static, dynamic)<br>
            5. Design of reinforced concrete and steel structures<br>
            6. Detailing and drawing generation<br>
            7. Seismic and wind load analysis<br>
