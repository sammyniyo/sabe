...
<head>
    ...
    <title>Prokon - Our Softwares Courses | SABE Ltd</title>
      ...
      <div class="col-lg-8">
        <div class="property-details-content">
          ...
          <div class="property-details-content-details">
            <p>Prokon is a suite of structural analysis and design software used primarily by structural engineers. It supports a wide range of structural analysis and design tasks.</p>
            <p class="bold">
              Course Content
            </p>
            <p>
            1. Introduction to Prokon<br>
            2. Structural analysis fundamentals<br>
            3. Steel design and detailing<br>
            4. Concrete design and detailing<br>
            5. Timber design<br>
            6. Load application and analysis<br>
            7. Connection design <br>
            8. Integration with other software<br>
            9. Hands-on Projects 
            </p>
          </div>
        </div>
